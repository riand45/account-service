...
func (h *userHandler) RegisterUser(c *gin.Context) {
	...
	if err != nil {
		response := helper.APIResponse("Register account failedsss", http.StatusBadRequest, "error", nil)
		c.JSON(http.StatusBadRequest, response)
		return
	}
...
func (h *userHandler) LoginUser(c *gin.Context) {
	...
	response := helper.APIResponse("Successful login", http.StatusOK, "success", formatter)
